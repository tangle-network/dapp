...
import { InputWrapper, TitleWithInfo } from '..';
 ...
 * ```
 */
export const TokenInput = forwardRef<HTMLDivElement, TokenInputProps>(({ className, token, ...props }, ref) => {
    ...
    <InputWrapper {...props} className={twMerge(cx({ 'items-start': balance }), className)} ref={ref}>
      ...
      {balance ? (
        <div className='flex flex-col items-end space-y-1'>
          <Typography variant='body4' fw='bold' component='span' className='uppercase text-mono-100 dark:text-mono-80'>

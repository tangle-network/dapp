...
export type chainMixers = {
  tornMixers: MixerInfo[];
};

export const rinkebyMixers: chainMixers = {
  tornMixers: [
    {
      size: 0.1,
...
export const ethMainNetMixers: chainMixers = {
  tornMixers: [],
};

export const beresheetMixers: chainMixers = {
  tornMixers: [
    {
      size: 10,
...
export const harmonyTest1Mixers: chainMixers = {
  tornMixers: [
    {
      size: 100,

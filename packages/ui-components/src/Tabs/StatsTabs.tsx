    ...
    <ContentWrapper>
      <TabHeader>
        <TabButton onClick={switchToInfo} active={activeTab === 'info'}>
          ...
          <span className='mixer-tab-label'>Token Info</span>
        </TabButton>
        <TabButton onClick={switchToStats} active={activeTab === 'statistics'}>
          <span className='mixer-tab-icon'>
            <svg width='36' height='36' viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <span className='mixer-tab-label'>Statistics</span>
        </TabButton>
      </TabHeader>

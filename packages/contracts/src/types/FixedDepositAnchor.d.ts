...
interface FixedDepositAnchorInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'wrapAndDeposit', values: [string, BytesLike]): string;
...
export type WithdrawalEvent = TypedEvent<[string, string, BigNumber] & { to: string; relayer: string; fee: BigNumber }>;
...
export class FixedDepositAnchor extends BaseContract {
  ...
  callStatic: {
    ...
    unwrapIntoNative(tokenAddress: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;

    unwrapIntoToken(tokenAddress: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    wrapAndDeposit(tokenAddress: string, _commitment: BytesLike, overrides?: CallOverrides): Promise<void>;

    wrapNative(overrides?: CallOverrides): Promise<void>;

    wrapToken(tokenAddress: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'Withdrawal(address,address,uint256)'(
      ...
      relayer?: string | null,
      fee?: null
    ): TypedEventFilter<[string, string, BigNumber], { to: string; relayer: string; fee: BigNumber }>;

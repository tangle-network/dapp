...
export class GovernedTokenWrapper extends BaseContract {
  ...
  add(tokenAddress: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    add(tokenAddress: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    updateLimit(limit: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

...
interface Erc20AnchorInterface extends Interface {
  functions: {
...
export class Erc20Anchor extends Contract {
  connect(signerOrProvider: Signer | Provider | string): Erc20Anchor;
  attach(addressOrName: string): Erc20Anchor;
  deployed(): Promise<Erc20Anchor>;

  on(event: EventFilter | string, listener: Listener): Erc20Anchor;
  once(event: EventFilter | string, listener: Listener): Erc20Anchor;
  addListener(eventName: EventFilter | string, listener: Listener): Erc20Anchor;
  removeAllListeners(eventName: EventFilter | string): Erc20Anchor;
  removeListener(eventName: any, listener: Listener): Erc20Anchor;
  ...
  functions: {
    ...
    token(overrides?: TransactionOverrides): Promise<string>;
  ...
  estimate: {
    ...
    token(overrides?: TransactionOverrides): Promise<BigNumber>;

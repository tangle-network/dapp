...
export type BlockUnsignedProposalsQueuesArgs = {
  after?: InputMaybe<Scalars['Cursor']>;
  before?: InputMaybe<Scalars['Cursor']>;
  distinct?: InputMaybe<Array<InputMaybe<Unsigned_Proposals_Queues_Distinct_Enum>>>;
...
export type ProposalItemProposalTimelineStatusesArgs = {
  after?: InputMaybe<Scalars['Cursor']>;
  before?: InputMaybe<Scalars['Cursor']>;
  distinct?: InputMaybe<Array<InputMaybe<Proposal_Timeline_Statuses_Distinct_Enum>>>;
...
export type ProposalItemUnsignedProposalsQueueItemsByProposalIdArgs = {
  after?: InputMaybe<Scalars['Cursor']>;
  before?: InputMaybe<Scalars['Cursor']>;
  distinct?: InputMaybe<Array<InputMaybe<Unsigned_Proposals_Queue_Items_Distinct_Enum>>>;
...
export type ValidatorOfSessionQuery = { __typename?: 'Query', sessionValidator?: { __typename?: 'SessionValidator', id: string, sessionId: string, reputation: number, uptime: number, isBest: boolean, isNext: boolean, isNextBest: boolean, bestOrder: number, nextBestOrder: number, session?: { __typename?: 'Session', thresholds: { __typename?: 'ThresholdsConnection', nodes: Array<{ __typename?: 'Threshold', next: number, current: number, pending: number, variant: ThresholdVariant } | null> } } | null, validator?: { __typename?: 'Validator', authorityId: string, id: string, account?: { __typename?: 'Account', id: string, countryCodeId?: string | null } | null } | null } | null, sessionValidators?: { __typename?: 'SessionValidatorsConnection', aggregates?: { __typename?: 'SessionValidatorAggregates', distinctCount?: { __typename?: 'SessionValidatorDistinctCountAggregates', id?: any | null } | null } | null } | null };
...
export type ProposalListViewFragment = { __typename?: 'ProposalItem', id: string, data: string, signature?: string | null, type: ProposalType, status: string, chainId?: any | null, proposalVotesByProposalId: { __typename?: 'ProposalVotesConnection', totalCount: number, nodes: Array<{ __typename?: 'ProposalVote', id: string, voterId: string, voter?: { __typename?: 'Proposer', id: string } | null } | null> }, block?: { __typename?: 'Block', timestamp?: any | null, number: any } | null };

export type ProposalsVoteListViewFragment = { __typename?: 'ProposalVote', id: string, voterId: string, voteStatus: VoteType, txHash: string, block?: { __typename?: 'Block', timestamp?: any | null, number: any } | null };
...
export type ProposalVotesWithVotesTypeQuery = { __typename?: 'Query', proposalVotes?: { __typename?: 'ProposalVotesConnection', totalCount: number, nodes: Array<{ __typename?: 'ProposalVote', id: string, voterId: string, voteStatus: VoteType, txHash: string, block?: { __typename?: 'Block', timestamp?: any | null, number: any } | null } | null>, pageInfo: { __typename?: 'PageInfo', endCursor?: any | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: any | null } } | null };
...
export type ProposalVotesWithoutVotesTypeQuery = { __typename?: 'Query', proposalVotes?: { __typename?: 'ProposalVotesConnection', totalCount: number, nodes: Array<{ __typename?: 'ProposalVote', id: string, voterId: string, voteStatus: VoteType, txHash: string, block?: { __typename?: 'Block', timestamp?: any | null, number: any } | null } | null>, pageInfo: { __typename?: 'PageInfo', endCursor?: any | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: any | null } } | null };
...
export const ProposalVotesWithVotesTypeDocument = gql`
    query ProposalVotesWithVotesType($perPage: Int!, $offset: Int!, $proposalId: String!, $voteType: VoteType) {
  proposalVotes(
    filter: {proposalId: {equalTo: $proposalId}, voteStatus: {equalTo: $voteType}}
    orderBy: [BLOCK_NUMBER_DESC]
    first: $perPage
    offset: $offset
  ) {
 ...
 * });
 */
export function useProposalVotesWithVotesTypeQuery(baseOptions: Apollo.QueryHookOptions<ProposalVotesWithVotesTypeQuery, ProposalVotesWithVotesTypeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProposalVotesWithVotesTypeQuery, ProposalVotesWithVotesTypeQueryVariables>(ProposalVotesWithVotesTypeDocument, options);
      }
export function useProposalVotesWithVotesTypeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProposalVotesWithVotesTypeQuery, ProposalVotesWithVotesTypeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProposalVotesWithVotesTypeQuery, ProposalVotesWithVotesTypeQueryVariables>(ProposalVotesWithVotesTypeDocument, options);
        }
export type ProposalVotesWithVotesTypeQueryHookResult = ReturnType<typeof useProposalVotesWithVotesTypeQuery>;
export type ProposalVotesWithVotesTypeLazyQueryHookResult = ReturnType<typeof useProposalVotesWithVotesTypeLazyQuery>;
export type ProposalVotesWithVotesTypeQueryResult = Apollo.QueryResult<ProposalVotesWithVotesTypeQuery, ProposalVotesWithVotesTypeQueryVariables>;
export const ProposalVotesWithoutVotesTypeDocument = gql`
    query ProposalVotesWithoutVotesType($perPage: Int!, $offset: Int!, $proposalId: String!) {
  proposalVotes(
 ...
 * });
 */
export function useProposalVotesWithoutVotesTypeQuery(baseOptions: Apollo.QueryHookOptions<ProposalVotesWithoutVotesTypeQuery, ProposalVotesWithoutVotesTypeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProposalVotesWithoutVotesTypeQuery, ProposalVotesWithoutVotesTypeQueryVariables>(ProposalVotesWithoutVotesTypeDocument, options);
      }
export function useProposalVotesWithoutVotesTypeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProposalVotesWithoutVotesTypeQuery, ProposalVotesWithoutVotesTypeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProposalVotesWithoutVotesTypeQuery, ProposalVotesWithoutVotesTypeQueryVariables>(ProposalVotesWithoutVotesTypeDocument, options);
        }
export type ProposalVotesWithoutVotesTypeQueryHookResult = ReturnType<typeof useProposalVotesWithoutVotesTypeQuery>;
export type ProposalVotesWithoutVotesTypeLazyQueryHookResult = ReturnType<typeof useProposalVotesWithoutVotesTypeLazyQuery>;
export type ProposalVotesWithoutVotesTypeQueryResult = Apollo.QueryResult<ProposalVotesWithoutVotesTypeQuery, ProposalVotesWithoutVotesTypeQueryVariables>;

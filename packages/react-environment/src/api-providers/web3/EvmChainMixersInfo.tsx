...
import { WebbEVMChain, rinkebyMixers, ethMainNetMixers, beresheetMixers, edgewareMixers, MixerInfo } from '@webb-dapp/apps/configs/evm/Mixers';
...
export class EvmChainMixersInfo {
  ...
  getMixersTitles(tokenSymbol: string): MixerTitle[] {

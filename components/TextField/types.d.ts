...
export interface TextFieldRootProps extends PropsOf<'div'>, TextFieldContextValue {
}
export interface TextFieldSlotProps extends PropsOf<'div'> {
}
export interface TextFieldInputProps extends Omit<PropsOf<'input'>, 'disabled'>, TextFieldContextValue {
}

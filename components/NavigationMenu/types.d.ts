...
import { Dropdown, DropdownBasicButton, DropdownBody, DropdownMenuItem } from '../Dropdown';
...
export interface NavigationMenuContentProps extends ComponentProps<typeof DropdownBody> {
     ...
     */
    extraMenuItems?: Array<React.ReactElement<DropdownMenuItemProps, typeof DropdownMenuItem>>;
    /**
     * The app version
     */
    version?: string;

...
export interface InputFieldRootProps extends PropsOf<'div'>, InputFieldContextValue {
}
export interface InputFieldSlotProps extends PropsOf<'div'> {
}
export interface InputFieldInputProps extends Omit<PropsOf<'input'>, 'disabled'>, InputFieldContextValue {

import { ComponentProps, ComponentPropsWithRef, ComponentPropsWithoutRef, ElementType, ReactElement, ReactNode } from '../../../../../node_modules/react';
import { PropsOf } from '../../types';
import { AdjustAmount } from '../BridgeInputs';
import { TextFieldInput } from '../TextField';
import { default as TokenSelector } from '../TokenSelector';
...
export interface TransactionInputCardRootProps extends PropsOf<'div'>, TransactionInputCardContextValue {
}
export type TransactionChainSelectorProps<TAs extends ElementType> = {
    as?: TAs;
} & Omit<ComponentPropsWithoutRef<ElementType extends TAs ? 'button' : TAs>, 'as'> & Pick<TransactionInputCardContextValue, 'typedChainId'> & {
    /**
...
export interface TransactionMaxAmountButtonProps extends PropsOf<'button'>, Pick<TransactionInputCardContextValue, 'tokenSymbol' | 'maxAmount' | 'accountType' | 'onAmountChange'> {
    /**
...
export interface TransactionInputCardBodyProps extends PropsOf<'div'>, Pick<TransactionInputCardContextValue, 'amount' | 'onAmountChange' | 'tokenSymbol' | 'isFixedAmount'> {
...
export interface TransactionInputCardFooterProps extends PropsOf<'div'>, Pick<TransactionInputCardContextValue, 'isFixedAmount' | 'onIsFixedAmountChange'> {
    /**

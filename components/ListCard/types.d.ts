...
export interface ContractListCardProps extends Omit<PropsOf<'div'>, 'onChange'> {
    selectContractItems: ContractType[];
    isLoading?: boolean;
}
export interface RelayerListCardProps extends Partial<Omit<ListCardWrapperProps, 'onChange'>> {
    /**

import { ReactHTML } from '../../../../node_modules/react';
...
export type TypographyFontWeightValues = 'normal' | 'medium' | 'semibold' | 'bold' | 'black';
...
export type MarketingVariant = 'mkt-h1' | 'mkt-h2' | 'mkt-h3' | 'mkt-h4' | 'mkt-subheading' | 'mkt-body1' | 'mkt-body2' | 'mkt-small-caps' | 'mkt-caption' | 'mkt-monospace';
export type TypographyVariant = HeadingVariant | BodyVariant | MonospaceVariant | ParagraphVariant | LabelVariant | MarketingVariant;
/**
 ...
 */
export interface TypographyProps<TypoVariant = TypographyVariant> extends TypographyBaseProps, ComponentBase {
    /**

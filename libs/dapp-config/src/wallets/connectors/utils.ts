import type { WalletProviderFlags, WindowProvider } from "./types.js";
 ...
 */
export function getExplicitInjectedProvider(flag: WalletProviderFlags) {
  const _window =
 ...
 */
export function getWindowProviderNamespace(namespace: string) {

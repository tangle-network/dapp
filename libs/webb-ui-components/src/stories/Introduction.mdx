...
import { ReactComponent as Code } from './assets/code-brackets.svg';
...
import { ReactComponent as StackAlt } from './assets/stackalt.svg';
...
<div className="link-list">
  ...
  <a
    className="link-item"
    href="https://docs.webb.tools/how-to-guides/v1/"
    target="_blank"
  >
    <Direction />
    <span>

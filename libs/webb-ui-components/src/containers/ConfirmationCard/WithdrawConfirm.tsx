import { ArrowRight, Close, Download, ExternalLinkLine, FileCopyLine } from '@webb-tools/icons';
...
export const WithdrawConfirm = forwardRef<HTMLDivElement, WithdrawConfirmationProps>(
  (
    ...
    return (
      <div
        {...props}
        className={twMerge('p-4 rounded-lg bg-mono-0 dark:bg-mono-180 min-w-[550px] space-y-6', className)}
        ref={ref}
      >
        {/** Title */}
        ...
        <div className='space-y-2'>
          ...
          <div className='flex items-center justify-between'>
            <div className='px-4 py-1.5 bg-mono-20 dark:bg-mono-160 rounded-lg grow max-w-[438px] truncate'>
              <Typography variant='mono1' fw='bold' className='text-mono-140 dark:text-mono-0'>
                {note}
              </Typography>
            </div>
            <Button variant='utility' size='sm' className='p-2' onClick={onCopy}>
              <FileCopyLine className='!fill-current' />
            </Button>
            <Button variant='utility' size='sm' className='p-2' onClick={onDownload}>
              <Download className='!fill-current' />
            </Button>
          </div>
          <CheckBox {...checkboxProps} wrapperClassName={twMerge('flex items-center', checkboxProps?.wrapperClassName)}>

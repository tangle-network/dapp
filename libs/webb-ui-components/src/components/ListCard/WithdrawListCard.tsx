        ...
        >
          {assetPairs && assetPairs.length > 0 && (
            <>
              ...
              <Typography variant='utility' className='uppercase text-mono-100 dark:text-mono-80' ta='center'>
                <Button variant='link' size='sm' className='mt-1 text-center' onClick={onSwitchWallet as unknown as MouseEventHandler<HTMLButtonElement>}>
                  Switch Wallet
                </Button>
                {' or '}
                <Button variant='link' size='sm' className='mt-1 text-center' onClick={onRecoverWithSecretNote as unknown as MouseEventHandler<HTMLButtonElement>}>

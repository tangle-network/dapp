...
const Scrollbar = forwardRef<HTMLDivElement, ScrollAreaPrimitive.ScrollAreaScrollbarProps>(
...
const Thumb: FC = forwardRef<HTMLDivElement, ScrollAreaPrimitive.ScrollAreaThumbProps>(
  ({ className, ...props }, ref) => (
...
const Corner = forwardRef<HTMLDivElement, ScrollAreaPrimitive.ScrollAreaCornerProps>(({ className, ...props }, ref) => (
  <ScrollAreaPrimitive.Corner {...props} className={twMerge('bg-transparent', className)} ref={ref} />
));

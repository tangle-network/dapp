  ...
  (
    ...
    return (
      <div
        {...props}
        className={cx(
          'flex items-center justify-center w-[500px] h-[275px] box-border p-10 mx-auto',
          className
        )}
        ref={ref}
      >
        <div className="relative">
          ...
          {sourceChain === 'dot' && (
            <span
              className={cx('absolute -translate-y-full top-[5%] right-full')}
            >
          ...
          {destChain === 'dot' && (
            <span
              className={cx('absolute -translate-y-full top-[20%] right-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {destLabel}
          ...
          {sourceChain === 'avax' && (
            <span
              className={cx(
                'absolute -translate-x-7 -translate-y-12 top-0 right-1/2'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {destChain === 'avax' && (
            <span
              className={cx(
                'absolute translate-x-7 -translate-y-12 top-0 left-1/2'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {sourceChain === 'ksm' && (
            <span
              className={cx('absolute -translate-y-full top-[5%] left-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {sourceLabel}
          ...
          {destChain === 'ksm' && (
            <span
              className={cx('absolute -translate-y-full top-[20%] left-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {destLabel}
          ...
          {sourceChain === 'eth' && (
            <span
              className={cx(
                'absolute translate-x-7 -translate-y-full top-[40%] left-full'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {destChain === 'eth' && (
            <span
              className={cx(
                'absolute translate-x-7 translate-y-full bottom-[40%] left-full'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {sourceChain === 'matic' && (
            <span
              className={cx('absolute translate-y-full bottom-[5%] left-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {sourceLabel}
          ...
          {destChain === 'matic' && (
            <span
              className={cx('absolute translate-y-full bottom-[20%] left-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {destLabel}
          ...
          {sourceChain === 'op' && (
            <span
              className={cx(
                'absolute -translate-x-7 translate-y-12 bottom-0 right-1/2'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {destChain === 'op' && (
            <span
              className={cx(
                'absolute translate-x-7 translate-y-12 bottom-0 left-1/2'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {sourceChain === 'arbitrum' && (
            <span
              className={cx('absolute translate-y-full bottom-[5%] right-full')}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
                  {sourceLabel}
          ...
          {destChain === 'arbitrum' && (
            <span
              className={cx(
                'absolute translate-y-full bottom-[20%] right-full'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {sourceChain === 'one' && (
            <span
              className={cx(
                'absolute -translate-x-5 -translate-y-full top-[40%] right-full'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">
          ...
          {destChain === 'one' && (
            <span
              className={cx(
                'absolute -translate-x-5 translate-y-full bottom-[40%] right-full'
              )}
            >
              <span className="relative">
                <Chip color="purple" className="min-w-max">

...
var definitions$1 = {
    rpc: {
        queryUserRewards: {
            description: "Query all the rewards of a specific asset for a specific user",
...
var definitions = {
    rpc: {
        queryServicesWithBlueprintsByOperator: {
            description: "Query all the services that this operator is providing along with their blueprints.",
        ...
        queryServiceRequestsWithBlueprintsByOperator: {
            description: "Query all pending service requests associated with a specific operator and blueprints.",
    ...
    types: {
        ...
        Service: {
            ...
            blueprint: "u64",
            owner: "AccountId32",
            operatorSecurityCommitments: "Vec<(AccountId32,Vec<AssetSecurityCommitment>)>",
            securityRequirements: "Vec<AssetSecurityRequirement>",
            permittedCallers: "Vec<AccountId32>",
            ttl: "u64",
            membershipModel: "MembershipModel"
...
/* eslint-disable */ /* eslint-disable sort-keys */ var lookup = {
    /**
...
const typesBundleForPolkadot = tangleTypesBundle;

exports.tangleLookupTypes = lookup$1;
exports.tangleRpc = tangleRpc;
exports.tangleTypes = tangleTypes;
exports.tangleTypesBundle = tangleTypesBundle;

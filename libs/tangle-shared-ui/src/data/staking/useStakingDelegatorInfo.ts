...
import { DelegatorInfo } from '../../types/staking';
import createStakingAssetId from '../../utils/createStakingAssetId';

export default function useStakingDelegatorInfo() {
...
function getWithdrawRequests(
  ...
  return requests.map((req) => {
    return {
      ...
      assetId: createStakingAssetId(req.asset),

...
const ABI = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      { name: 'blueprintId', type: 'uint64', indexed: true, internalType: 'uint64' },
      { name: 'versionId', type: 'uint64', indexed: true, internalType: 'uint64' },
      { name: 'sha256Hash', type: 'bytes32', indexed: false, internalType: 'bytes32' },
      { name: 'binaryUri', type: 'string', indexed: false, internalType: 'string' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'serviceId', type: 'uint64', indexed: true, internalType: 'uint64' },
      {
        name: 'policy',
        type: 'uint8',
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'severityFound', type: 'uint8', indexed: false, internalType: 'uint8' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'versionId', type: 'uint64', indexed: true, internalType: 'uint64' },
      { name: 'attestationId', type: 'uint64', indexed: false, internalType: 'uint64' },
      { name: 'reasonUri', type: 'string', indexed: false, internalType: 'string' },
    ],
    anonymous: false,
  },
] as const;

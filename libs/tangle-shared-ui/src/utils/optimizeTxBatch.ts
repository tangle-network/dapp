...
// NOTE: Could also be improved to handle block weight limits here automatically; keep creating batches until the block weight limit is reached, then send the batch and continue with the remaining transactions.

...
import { FilterFn, PartialKeys, RowData, TableOptionsResolved } from '@tanstack/react-table';
import { Nullable, Maybe } from '../../../dapp-types/src/utils/types';
...
export interface ComponentBase extends React.HTMLAttributes<HTMLElement>, IComponentBase {
}
/**
 ...
 */
export type EventFor<TElement extends keyof JSX.IntrinsicElements, THandler extends GetEventHandlers<TElement>> = JSX.IntrinsicElements[TElement][THandler] extends ((e: infer TEvent) => any) | undefined ? TEvent : never;
export {};

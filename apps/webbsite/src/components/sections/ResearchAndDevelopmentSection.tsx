...
const sections: Array<Section> = [
  ...
  },
  {
    ...
    description:
      'We leverage multi-party computation protocols used to decentralizeå trust over a set of parties to facilitate governance and operation of Anchor Protocol instances.',
    sourceCodeUrl: 'https://github.com/webb-tools',
    documentationUrl: 'https://docs.webb.tools',
  },
  {
  ...
  return (
    <section className="h-[1215px] w-full flex items-center justify-center relative">
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[46%] left-[19%]"
      >
        <ellipse
          cx="68.5078"
          cy="72.0962"

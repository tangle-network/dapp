import { WEBB_DOC_ROUTES_RECORD } from '@tangle-network/webb-ui-components/constants';
import FAQContainer from '@tangle-network/webb-ui-components/containers/FAQSection';

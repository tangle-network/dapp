...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <a href="https://docs.webb.tools/docs/tangle-network/overview/" target="_blank" rel="noopener noreferrer">
  ...
  },
  {
    ...
    answer:
      'We're focusing on concierge access to our team for developers, publicity for succesful validators and more. Details to come.',
  },
];

import { TESTNET_LEADERBOARD_URL } from '@tangle-network/webb-ui-components/constants';
import type { FAQItem } from '@tangle-network/webb-ui-components/containers/FAQSection';

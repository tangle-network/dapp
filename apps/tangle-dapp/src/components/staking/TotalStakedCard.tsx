/**
 * Card displaying user's total staked value and withdrawal status.
...
const TotalStakedCard: FC = () => {
  ...
  const { data: stats, isLoading } = useUserStakingStats();

  const handleUndelegate = () => {
    navigate(PagePath.STAKING_UNDELEGATE);
  };

  const handleManageBalances = () => {
    navigate(PagePath.STAKING_WITHDRAW);
  };

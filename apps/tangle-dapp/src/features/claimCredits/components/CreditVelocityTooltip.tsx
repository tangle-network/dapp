...
import { Tooltip, TooltipBody, TooltipTrigger } from '@tangle-network/ui-components';
import { TANGLE_TOKEN_DECIMALS } from '@tangle-network/dapp-config';
import { formatDisplayAmount, AmountFormatStyle } from '@tangle-network/ui-components';
import {
    ...
    <Tooltip>
      ...
      <TooltipBody className="max-w-xs p-3 space-y-2">
        ...
        {!creditsNeeded.isZero() && (
          <Typography variant="body2" className="text-mono-120 dark:text-mono-80">
            You need {formattedCreditsNeeded} {tokenSymbol} more to reach the minimum.
          </Typography>
        )}
      </TooltipBody>
    </Tooltip>

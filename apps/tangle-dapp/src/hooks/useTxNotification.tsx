...
export const SUCCESS_MESSAGES: Record<TxName, string> = {
  ...
  [TxName.UPDATE_STAKING_PROFILE]: 'Stake profile updated successfully',
  ...
  [TxName.STAKING_JOIN_OPERATORS]: 'Joined as an operator',
  [TxName.STAKING_DEPOSIT]: 'Deposited tokens successfully',
  [TxName.STAKING_DELEGATE]: 'Delegated tokens successfully',
  [TxName.STAKING_UNSTAKE]: 'Scheduled undelegate request',
  [TxName.STAKING_WITHDRAW]: 'Scheduled withdrawal request',
  [TxName.STAKING_CANCEL_UNSTAKE]: 'Cancelled undelegate request(s)',
  [TxName.STAKING_EXECUTE_UNSTAKE]: 'Executed undelegate request',
  [TxName.STAKING_EXECUTE_WITHDRAW]: 'Executed withdraw request',
  [TxName.STAKING_CANCEL_WITHDRAW]: 'Cancelled withdraw request(s)',
  ...
  [TxName.STAKING_NATIVE_DELEGATE]:
    'Native staking delegation completed successfully',
  [TxName.STAKING_NATIVE_UNSTAKE]: 'Scheduled undelegate request',
  [TxName.STAKING_NATIVE_UNSTAKE_EXECUTE]: 'Executed undelegate request(s)',
  [TxName.STAKING_DEPOSITED_UNSTAKE_EXECUTE]: 'Executed undelegate request(s)',
  [TxName.STAKING_NATIVE_UNSTAKE_CANCEL]: 'Cancelled undelegate request(s)',
  [TxName.STAKING_UNSTAKE_EXECUTE_ALL]: 'Executed all undelegate requests',
};

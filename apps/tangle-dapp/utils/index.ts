...
export { default as getChartAreaColorByServiceType } from './getChartAreaColorByServiceType';
export { default as getChipColorByServiceType } from './getChipColorByServiceType';

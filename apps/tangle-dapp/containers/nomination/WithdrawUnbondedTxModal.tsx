...
import { BondedTokensBalanceInfo } from '../../components/nomination/BondedTokensBalanceInfo';
...
export type WithdrawUnbondedTxModalProps = {
  isModalOpen: boolean;
  setIsModalOpen: (isModalOpen: boolean) => void;
};

const WithdrawUnbondedTxModal: FC<WithdrawUnbondedTxModalProps> = ({
  isModalOpen,
  setIsModalOpen,
}) => {

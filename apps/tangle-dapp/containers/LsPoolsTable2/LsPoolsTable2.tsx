...
const POOL_COLUMN_HELPER = createColumnHelper<LsPool>();

const POOL_COLUMNS = [
  POOL_COLUMN_HELPER.accessor('id', {
    header: () => 'Name/id',
    cell: (props) => (
      <Typography
        variant="body2"
  ...
  POOL_COLUMN_HELPER.accessor('token', {
    header: () => 'Token',
    cell: (props) => (
      <Typography
        variant="body2"
  ...
  POOL_COLUMN_HELPER.accessor('totalStaked', {
    header: () => 'TVL',
    // TODO: Decimals.
    cell: (props) => <TokenAmountCell amount={props.getValue()} />,
  }),
  POOL_COLUMN_HELPER.accessor('apyPercentage', {
    header: () => 'APY',
    cell: (props) => {

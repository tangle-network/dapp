        ...
        <CardContent className="relative p-6 md:p-8">
          ...
          <div className="relative max-w-4xl space-y-5">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-3xl text-base leading-7 text-mono-100 dark:text-mono-60">
            ...
            <Card variant="sandbox" className="rounded-3xl">
              <CardContent className="p-6">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-widest text-mono-100 dark:text-mono-60">
                      Status
                    </p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-mono-100 dark:text-mono-60">
              ...
              {jobs.map((job, index) => (
                ...
                >
                  ...
                  <div className="mt-3 space-y-2">
                    <p className="text-xs font-semibold text-mono-100 dark:text-mono-60">
                      Params:{' '}
            ...
            <div className="mt-4 flex flex-col gap-3">
              {recentCalls.slice(0, 5).map((call) => (
                ...
                >
                  ...
                  <p className="mt-2 break-all text-xs font-semibold text-mono-100 dark:text-mono-60">

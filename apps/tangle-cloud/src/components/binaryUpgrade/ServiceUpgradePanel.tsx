    ...
    return (
      <Card variant="elevated">
        <CardContent className="p-5 md:p-6">
          ...
          <p className="mt-2 text-mono-100 dark:text-mono-60 text-sm">
    ...
    <Card variant="elevated">
      <CardContent className="p-5 md:p-6 space-y-5">
        ...
        <fieldset className="space-y-2">
          <legend className="font-semibold text-[10px] text-mono-100 dark:text-mono-60 uppercase tracking-wider">
            Upgrade policy
          </legend>
...
const VersionCard: FC<{
  ...
  >
    ...
    <p className="mt-2 truncate font-mono text-mono-100 dark:text-mono-60 text-xs">

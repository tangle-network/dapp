      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {isExpired && !isRevoked && (
              <span className="text-mono-100 dark:text-mono-60 text-[10px] uppercase tracking-wider">
                (expired)
              </span>
            )}
          </div>
          <p className="mt-0.5 truncate font-mono text-mono-100 dark:text-mono-60 text-xs">

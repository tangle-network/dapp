        ...
        <div className="flex flex-wrap items-start justify-start gap-2">
          {socialLinks.map((link, index) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-mono-60 dark:border-mono-170 px-3 py-1 text-mono-100 dark:text-mono-60 text-xs hover:text-mono-200 dark:text-mono-0"
            >
              {link.name ?? 'Link'}
            </a>
          ))}

...
export const CircularProgress: FC<{
  ...
  <span
    title={tooltip}
    className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-mono-60 dark:border-mono-170 bg-mono-0 dark:bg-mono-190 text-[10px] text-mono-100 dark:text-mono-60"
  >
...
export const Input: FC<InputProps> = ({
  ...
  <div className={['relative', className].filter(Boolean).join(' ')}>
    ...
    />
    {leftIcon && (
      <div className="pointer-events-none absolute inset-y-0 left-3 flex items-center text-mono-100 dark:text-mono-60">
        {leftIcon}
      </div>
    )}
    {rightIcon && (
    ...
    type === 'error'
      ...
      : type === 'warning'
        ...
        : type === 'success'
          ...
          : 'border-mono-60 dark:border-mono-170 bg-mono-20/50 dark:bg-mono-190/50 text-mono-100 dark:text-mono-60';

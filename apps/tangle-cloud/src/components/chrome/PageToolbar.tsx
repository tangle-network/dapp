  ...
  return (
    ...
    >
      <div className="relative flex min-w-[180px] flex-[1_1_260px] items-center">
        <Search
          className="pointer-events-none absolute left-3 h-4 w-4 fill-current text-mono-100 dark:text-mono-60"
          aria-hidden
        />
        <input
          type="search"
          ...
          className={twMerge(
            'h-9 w-full rounded-md border border-transparent bg-transparent pl-9 pr-3 font-sans text-sm leading-tight text-mono-200 dark:text-mono-0 not-italic placeholder:text-mono-100 dark:text-mono-60/70',
      ...
      {count !== undefined && (
        <span
          className={twMerge(
            typeRole.mono,
            'shrink-0 text-mono-100 dark:text-mono-60 tabular-nums',
          )}
          aria-live="polite"
        >

...
import { useScheduleExitTx } from './useScheduleExitTx';
...
describe('useScheduleExitTx', () => {
  ...
  it('uses scheduleExit with service id args', async () => {
    let capturedFactory:
    ...
    expect(config.functionName).toBe('scheduleExit');
    expect(config.args).toEqual([13n]);
  });
  ...
  it('invalidates exit queries after successful tx', () => {
    ...
    renderHook(() => useScheduleExitTx({ onSuccess }));
